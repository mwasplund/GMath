#pragma once
#include "Point4FTests.h"

TestState RunPoint4FTests() 
{
	auto className = "Point4FTests";
	auto testClass = std::make_shared<GMath::Tests::Point4FTests>();
	TestState state = { 0, 0 };
	...
	state += Soup::Test::RunTest(className, "Initialize_UnitW", [&testClass]() { testClass->Initialize_UnitW(); });
	...
	state += Soup::Test::RunTest(className, "SetW_SetsValue", [&testClass]() { testClass->SetW_SetsValue(); });
	...
	state += Soup::Test::RunTest(className, "Operator_Equal_WNotSameReturnsFalse", [&testClass]() { testClass->Operator_Equal_WNotSameReturnsFalse(); });
	...
	state += Soup::Test::RunTest(className, "Operator_NotEqual_WNotSameRetunsTrue", [&testClass]() { testClass->Operator_NotEqual_WNotSameRetunsTrue(); });
